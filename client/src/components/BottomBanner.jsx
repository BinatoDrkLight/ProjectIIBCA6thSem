...
const BottomBanner = ()=>{
    return (
        <div className='relative mt-22'>
            ...
            <img src={assets.BottomBannerSm} alt="bottomBannerSm" className='mx-auto w-[30rem] h-[22rem] sm:w-[34rem] sm:h-[30rem] md:w-[40rem] md:h-[34rem] lg:hidden'/>

            <div className='absolute inset-0 flex flex-col items-center justify-center lg:items-end lg:justify-center p-4 xl:pr-24'>
                <div>
                    <h1 className='text-xl sm:text-3xl md:text-3xl font-semibold text-primary mb:2 sm:mb-8 md:mb-2'>Why We Are The Best?</h1>
