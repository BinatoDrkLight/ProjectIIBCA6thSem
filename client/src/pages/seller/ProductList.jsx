...
//import { removeProduct } from '../../../../server/controllers/productController';
                        ...
                        <tbody className="text-sm text-gray-500">
                            {products.map((product) => (
                                <tr key={product._id} className="border-t border-gray-500/20">
                                    ...
                                    <td className="px-4 py-3">
                                         <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] select-none">
                                            <span className="w-5 text-center">{product.inStockAmount}</span>
                                        </div>
                                    </td>
                                    <td className="px-4 py-3">
                                         <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] select-none">
                                            <span className="w-5 text-center cursor-pointer" onClick={()=> removeProduct(product._id)}>
                                                <img src={assets.crossIcon}/>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
